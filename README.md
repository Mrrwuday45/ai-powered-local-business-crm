...
The main goal of this project is to provide local businesses with a smart CRM solution that combines customer management,
sales tracking, inventory control, and Artificial Intelligence.
...
Make better decisions using AI insights
🔮 Future Enhancements
